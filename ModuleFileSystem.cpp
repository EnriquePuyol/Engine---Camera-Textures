...
bool ModuleFileSystem::Init() {
	...
	if (Exists("/Data/Textures/")) {
		PHYSFS_mkdir("/Data/Textures/");
	}
	if (Exists("/Data/Meshes/")) {
		PHYSFS_mkdir("/Data/Meshes/");
	}
	if (Exists("/Data/Scenes/")) {
		PHYSFS_mkdir("/Data/Scenes/");
	}
	return true;
}
